<?php
if (! class_exists ( "PostmanSeatiAuthenticationManager" )) {
	 ...
	 */
	class PostmanSeatiAuthenticationManager extends PostmanAbstractAuthenticationManager implements PostmanAuthenticationManager {
		...
		const SEATI_ENDPOINT = 'https://api.autentica.seati.ma.gov.br/oauth';
		const SEATI_REFRESH = 'https://api.autentica.seati.ma.gov.br/oauth/token';
		
		// this scope doesn't work
		// Create, read, update, and delete drafts. Send messages and drafts.
		const SCOPE_COMPOSE = 'https://api.email.seati.ma.gov.br/api/mensagens/send';
		...
		const SCOPE_FULL_ACCESS = '';
		const AUTH_TEMP_ID = 'SEATI_OAUTH_TEMP_ID';
		const VENDOR_NAME = 'seati';
		...
		public function getAuthorizationUrl() {
			return self::SEATI_ENDPOINT;
		}
		public function getTokenUrl() {
			return self::SEATI_REFRESH;
		}
	}
}
